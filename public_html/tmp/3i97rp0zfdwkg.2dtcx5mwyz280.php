<div class="content-top">
    <div class="col-md-4 ">
        ...
        <div class="content-top-1">
            ...
            <div class="col-md-6 top-content1">
                <div id="demo-pie-2" class="pie-title-center" data-percent="10"><span
                        class="pie-value"></span></div>
            </div>
            <div class="clearfix"></div>
        </div>
    ...
    <div class="col-md-4 clearfix">
        <div class="grid-1">
            <h4>Jenis kelamin balita</h4>
            <div class="grid-graph">
                <div class="grid-graph1">
                    <div class="lbl-pie lbl-blue">Laki-laki <span>60%</span></div>
                    <div class="lbl-pie lbl-pink">Perempuan<span> 40%</span></div>
                </div>
            </div>
            <div class="grid-2">
                <canvas id="pie-jk" height="235" width="158" style="width: 235px; height: 158px;"></canvas>
            </div>
            <div class="clearfix"></div>
        </div>
    ...
    <div class="col-md-4 clearfix">
        <div class="grid-1">
            ...
            <div class="grid-graph">
                <div class="grid-graph1">
                    <div class="lbl-pie lbl-teal">PIL<span>30%</span></div>
                    <div class="lbl-pie lbl-green">Suntik<span> 40%</span></div>
                    <div class="lbl-pie lbl-lime">Spiral<span> 30%</span></div>
                </div>
            </div>
            <div class="grid-2">
                <canvas id="pie-kb" height="235" width="158" style="width: 235px; height: 158px;"></canvas>
            </div>
            <div class="clearfix"></div>
        </div>
    ...
    <div class="col-md-8">
        <div class="content-graph">
            <div class="content-color">
                <h4>Kunjungan Posyandu</h4>
                <hr/>
                <div class="content-ch"><p><i></i>Posyandu ASOY </p><span>100%</span>
                    <div class="clearfix"></div>
                </div>
                <div class="content-ch1"><p><i></i>Posyandu GEBOY</p><span> 70%</span>
                    <div class="clearfix"></div>
                </div>
            </div>
