                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#" class=" hvr-bounce-to-right">
                            <i class="fa fa-institution nav_icon"></i> <span class="nav-label">Administrasi</span><span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li><a href="daftar-posyandu.html" class=" hvr-bounce-to-right"> <i class="fa fa-hospital-o nav_icon"></i>Daftar Posyandu</a></li>
                            <li><a href="#" class=" hvr-bounce-to-right"> <i class="fa fa-users nav_icon"></i>Daftar Admin</a></li>
                            <li><a href="#" class=" hvr-bounce-to-right"> <i class="fa fa-eyedropper nav_icon"></i>Imunisasi & Vitamin</a></li>
                            <li><a href="#" class=" hvr-bounce-to-right"> <i class="fa fa-calendar nav_icon"></i>Penyuluhan</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
