            ...
            <ul class=" nav_1">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu " role="menu">
                        ...
                        <li><a href="<?php echo $BASE_URL; ?>logout"><i class="fa fa-sign-out"></i>Keluar</a></li>
                    </ul>
                </li>
...
<!--                            <li><a href="#" class=" hvr-bounce-to-right"><i class="fa fa-group nav_icon"></i>Keluarga berencana</a></li>-->
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a href="<?php echo $BASE_URL; ?>kader/daftar" class=" hvr-bounce-to-right"> <i class="fa fa-users nav_icon"></i>Daftar Kader</a></li>
                            <li><a href="<?php echo $BASE_URL; ?>posyandu/daftar" class=" hvr-bounce-to-right"> <i class="fa fa-hospital-o nav_icon"></i>Daftar Posyandu</a></li>
