...
var kms_meta = {
  "title": "Berat vs Umur (Kartu Menuju Sehat)",
  "lines": [{
    "tag":"normal",
    "name":"Normal"
  }, {
...
var kms_values = [{"Month":0,"normal":3.4,"mal":2.4,"smal":2},
					{"Month":6,"normal":8,"mal":5.5,"smal":4.6},
					{"Month":12,"normal":10.3,"mal":7.8,"smal":6.5},
					{"Month":18,"normal":11.5,"mal":8.7,"smal":7.3},
					{"Month":24,"normal":12.5,"mal":9.6,"smal":8.1},
					{"Month":30,"normal":13.7,"mal":10.5,"smal":9},
					{"Month":36,"normal":14.8,"mal":11.4,"smal":9.8},
					{"Month":42,"normal":15.7,"mal":12,"smal":10.3},
					{"Month":48,"normal":16.7,"mal":12.8,"smal":10.9},
					{"Month":54,"normal":17.8,"mal":13.5,"smal":11.5},
					{"Month":60,"normal":18.7,"mal":14.2,"smal":12}];

var kartu_menuju_sehat = {
  "meta" : kms_meta,
  "data" : kms_values
};
...
function display_growth_chart(patient, el, chartType, dims) {
  ...
  var metaData;
  var chartTypes = {
    'kartu_menuju_sehat' : kartu_menuju_sehat
  };
  ...
  var height = 350;
  var padding = 50;
  var extraRightPadding = 30; // For line labels ... "severely malnourished" goes offscreen
...
*/
  ...
  function getTooltipText(d) {
    ...
    var textAge = 'Umur: ' + getAgeText(age_in_months);
    var textweight = 'Berat: ' + weight_in_kg + 'kg';
